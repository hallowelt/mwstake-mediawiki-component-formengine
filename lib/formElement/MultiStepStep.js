( function ( mw, $, undefined ) {
	...
	mw.ext.forms.formElement.MultiStepStep.prototype.getElementConfig = function() {
		...
		newConfig.completionStep = {
			...
			name: 'completionStep',
			value: false,
			label: mw.message( 'ext-forms-label-completion-step' ).text(),
			help: mw.message( 'ext-forms-label-completion-step-help' ).text()
		};
	...
	mw.ext.forms.formElement.MultiStepStep.prototype.getDisplayName = function() {
		return mw.message( 'form-formelement-multi-step-step' ).text();
	};
