( function ( mw, $, undefined ) {
	...
	mw.ext.forms.formElement.SelectFile.prototype.getElementConfig = function() {
		var config = mw.ext.forms.formElement.SelectFile.parent.prototype.getElementConfigInternal.call( this );
		config.showDropTarget = {
			type: 'checkbox',
			value: true,
			name: 'showDropTarget',
			label: mw.message( 'ext-forms-label-show-drop-target' ).text(),
			widget_data: {
				tab: 'styling'
			}
		};
